...
class ResearchWorkflow:
    ...
    def init(self, ctx: WorkflowContext) -> list[str]:
        ...
        prompts = [
            ...
            f"/research_codebase_github for issue {issue_url}. Edit the issue DESCRIPTION to append a research section - ONLY if the issue description doesn't already contain `<!-- kiln:research -->`. IMPORTANT: The research section MUST be wrapped in `<!-- kiln:research -->` and `<!-- /kiln:research -->` markers.",
        ]
